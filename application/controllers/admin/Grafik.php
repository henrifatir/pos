...
class Grafik extends CI_Controller{
	...
	if($this->session->userdata('akses')=='1'){
		...
		$data['data']=$this->m_barang->tampil_barang($id);
		$data['kat']=$this->m_kategori->tampil_kategori();
		$data['jual_bln']=$this->m_laporan->get_bulan_jual($id);
		$data['jual_bln_all']=$this->m_laporan->get_bulan_jual_all();
		$data['jual_thn']=$this->m_laporan->get_tahun_jual($id);
		$data['jual_thn_all']=$this->m_laporan->get_tahun_jual_all();
