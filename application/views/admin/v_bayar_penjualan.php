...
<head>
    ...
    <title>Management Bayar Penjualan</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Pembayaran
                    <small>Penjualan Barang</small> <?php echo $t?>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                <?php 
                    ...
                    foreach ($bayar->result_array() as $a):
                        ...
                        $id=$a['jual_nofak'];
                        $tgl=$a['jual_tanggal'];
                        $total_beli=$a['jual_total'];
                        $total_bayar=$a['jual_jml_uang'];
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Pembayaran Penjualan Barang</h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/bayar_penjualan/edit_bayar'?>">
