   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form action="<?php echo base_url().'admin/penjualan_grosir/add_to_cart'?>" method="post" id='form1' name='form1'>
            <table>
                <tr>
                    <th>Kode Barang</th>
                </tr>
            ...
            <table>
                  <tr>
                    <th><label><input type="checkbox" name="kredit" value="kredit" >Cara Bayar Kredit</label></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <th>Kembalian(Rp)</th>
                    <th style="text-align:right;"><input type="text" id="kembalian" name="kembalian" class="form-control input-sm" style="text-align:right;margin-bottom:5px;"></th>
                </tr>
