...
<body>
   ...
   ?>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Data
                    ...
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Barang</a></div>  
                      <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModalManual"><span class="fa fa-plus"></span> Tambah Barang Manual</a></div>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:right;w"><?php echo 'Rp '.number_format($harjul);?></td>
        ...
        <!-- ADD BARANG MANUAL -->
              <div class="modal fade" id="largeModalManual" tabindex="-1" role="dialog" aria-labelledby="largeModalManual" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang_manual'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Barang</label>
                        <div class="col-xs-9">
                            <input name="nabar" id='nabar' class="form-control" type="text" placeholder="Nama Barang..." style="width:335px;" required>
                        </div>
                    </div>
