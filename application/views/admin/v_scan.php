...
<body>
   ...
   ?>
    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#scan" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center;">
                           <a class="btn btn-sm btn-default" href="#lap_pembelian" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
        ...
        <!-- MODAL PEMBELIAN-->
        <div class="modal fade" id="lap_pembelian" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel">Pilih Nomor Faktur Pembelian</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_pembelian'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >No Faktur</label>
                        <div class="col-xs-9">
                                <select name="faktur" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Faktur" data-width="80%" required/>
                                <?php foreach ($nofak->result_array() as $k) {
                                    $bln=$k['beli_kode'];
                                    $tgl=$k['beli_tanggal'];
                                ?>
                                    <option><?php echo $bln.'|'.$tgl;?></option>
                                <?php }?>
                                </select>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="scan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
