                   ...
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url().'admin/bayar_penjualan'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Pembayaran Penjualan</a></li> 
                             <li><a href="<?php echo base_url().'admin/bayar_pembelian'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Pembayaran Pembelian</a></li> 
                              <li><a href="<?php echo base_url().'admin/pesan_barang'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Pesan Barang gudang lain</a></li> 
                               <li><a href="<?php echo base_url().'admin/pindah_barang'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Pindah Barang gudang lain</a></li> 
